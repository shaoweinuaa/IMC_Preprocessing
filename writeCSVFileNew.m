...
columnNumber =max(sum(neighborMatrix,2))+44;
...
title={'ROI','CellId','X_position','Y_position','CCR7','CD14','FOXP3','CD16','HLAI','CD4','CD8','CollagenI','b2m','CD31',...
    'E-cadherin','CD127','CD56','CD7','CD163','IDO1','PDL1','VEGFA','CD68','CD11b','CD20','CD11c','CD15','Granzyme','PD1',...
    'Ki67','CD1c','HLA-DR','CD45RA','CD3','TNFa','CD27','CD45RO','CD57','C1QC','Pan-cytokeratin','aSMA','Vimentin','CD45','Number_Neighbors'};
...
csvFileName=strcat('.\\csvFile\\',roiName,'.csv');
      ...
      for j=1:length(title)
       ...
       for j=1:length(title)
          ...
          elseif j>1 && j<length(title)
              fprintf(fid,'%.6f,',outputMatrix(i-1,j-1));
          else
